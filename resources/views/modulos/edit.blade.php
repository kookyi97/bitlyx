...
<head>
    ...
    <title>Bitlyx — Editar Módulo</title>
...
<div class="app-wrapper">
    ...
    <main class="main-content">
        <div class="page-header">
            <div>
                <h1 class="page-title"><i class="fas fa-pen-alt" style="color:#4ADE80;margin-right:10px"></i>Editar Módulo</h1>
                <p style="color:#6B7280;font-size:.875rem;margin-top:4px">ID: #{{ $modulo->id }} — {{ $modulo->titulo }}</p>
            </div>
            ...
            <form action="/modulos/{{ $modulo->id }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="titulo" class="form-input" required maxlength="150"
                           value="{{ old('titulo', $modulo->titulo) }}" placeholder="Nombre del módulo">
                </div>
                <div class="form-group">
                    <label class="form-label"><i class="fas fa-align-left"></i> Descripción</label>
                    <textarea name="descripcion" class="form-textarea" rows="5"
                              placeholder="Descripción del módulo...">{{ old('descripcion', $modulo->descripcion) }}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Actualizar Módulo</button>
