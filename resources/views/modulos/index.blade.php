...
<head>
    ...
    <title>Bitlyx — Gestión de Módulos</title>
...
<div class="app-wrapper">
    ...
    <main class="main-content">
        <div class="page-header">
            <h1 class="page-title"><i class="fas fa-folder-tree" style="color:#4ADE80;margin-right:10px"></i>Gestión de Módulos</h1>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:140px">Lecciones</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><div class="td-desc" title="{{ $modulo->descripcion }}">{{ $modulo->descripcion }}</div></td>
                        <td>
                            @if($modulo->estado === 'publicado')
                                <span class="badge-publicado"><i class="fas fa-circle" style="font-size:.4rem"></i> Publicado</span>
                            @else
                                <span class="badge-borrador"><i class="fas fa-circle" style="font-size:.4rem"></i> Borrador</span>
                            @endif
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="btn-actions">
                                <form action="{{ route('modulos.toggleEstado', $modulo) }}" method="POST" style="display:inline">
                                    @csrf @method('PATCH')
                                    @if($modulo->estado === 'publicado')
                                        <button type="submit" class="btn-toggle-off"><i class="fas fa-eye-slash"></i> Despublicar</button>
                                    @else
                                        <button type="submit" class="btn-toggle-on"><i class="fas fa-eye"></i> Publicar</button>
                                    @endif
                                </form>
                                <a href="/modulos/{{ $modulo->id }}/edit" class="btn-warning"><i class="fas fa-edit"></i> Editar</a>
        ...
        <div style="margin-top:1.5rem;display:flex;justify-content:center">{{ $modulos->links() }}</div>
    </main>
</div>
