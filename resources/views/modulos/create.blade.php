...
<head>
    ...
    <title>Bitlyx Academy — Crear Módulo</title>
...
<body>
    <!-- Contenido principal - SIN barra superior ni botón volver -->
    <div class="main-content">
        <!-- Tarjeta de información -->
        <div class="module-info-card">
            <div class="module-title">
                <h2><i class="fas fa-plus-circle" style="color: #4ADE80; margin-right: 10px;"></i> Crear Nuevo Módulo</h2>
                <p>Completa los campos para agregar un nuevo módulo al sistema</p>
            </div>
            <div class="module-badge">
                <i class="fas fa-file-alt"></i> Nuevo registro
            </div>
        </div>
        ...
        <form action="/modulos" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="titulo" required maxlength="150" value="{{ old('titulo') }}" placeholder="Ej: Fundamentos de Programación">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="descripcion" rows="5" placeholder="Describe el contenido del módulo...">{{ old('descripcion') }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="estado">
                    ...
                    <option value="publicado" {{ old('estado', 'borrador') === 'publicado' ? 'selected' : '' }}>
                        Publicado
                    </option>
                </select>
            </div>
